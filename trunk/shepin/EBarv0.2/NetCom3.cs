            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    else 
                    {
                        ...
                        MessageBox.Show("连接服务器消息", "服务器断开重新连接失败！");
        ...
        private void AddArmSendCallback(IAsyncResult ar)
        {
            ...
            catch (Exception e)
            {
                ...
                if (!keepaliveFlag)
                {
                    ...
                    MessageBox.Show( "指令发送失败,AddArmSendCallback函数：" + e.Message);
        ...
        private void WashSendCallback(IAsyncResult ar)
        {
            ...
            catch (Exception e)
            {
                ...
                if (!keepaliveFlag)
                {
                    ...
                    MessageBox.Show( "指令发送失败，WashSendCallback：" + e.Message);
        ...
        private void MoveSendCallback(IAsyncResult ar)
        {
            ...
            catch (Exception e)
            {
                ...
                if (!keepaliveFlag)
                {
                    ...
                    MessageBox.Show( "指令发送失败，MoveSendCallback：" + e.Message);
        ...
        private void DiagnostSendCallback(IAsyncResult ar)
        {
            try
            {
                ...
                try
                {
                    ...
                    bool resu = DiagnostDone.WaitOne(60000, false);
                ...
                catch (Exception ex)
                {
                    ...
                    if (!keepaliveFlag)
                    {
                        if (!ex.Message.Contains("正在中止线程"))
                        {
                            ...
                            MessageBox.Show( "DiagnostSendCallback:" + ex.Message);
            ...
            catch (Exception e)
            {
                ...
                if (!keepaliveFlag)
                {
                    ...
                    MessageBox.Show( "DiagnostSendCallback指令发送失败：" + e.Message);
        ...
        private void OtherSendCallback(IAsyncResult ar)
        {
            ...
            catch (Exception e)
            {
                ...
                if (!keepaliveFlag)
                {
                    ...
                    //        EventStop();
                    //    
                    //    MessageBox.Show( "指令发送失败：" + e.Message);
                    //    
                }
            }
        }
                    ...
                    if (bytesRead > 0)
                    {
                        ...
                        foreach (string tempResponse in ReciveData)
                        {
                            ...
                            if (tempResponse.ToString().IndexOf("EB 90") > -1)
                            {
                                ...
                                if (orderTemp.Substring(0, 2) == "CA" || orderTemp == "11 FF" || orderTemp == "11 AF" || orderTemp == "01 A0" || orderTemp == "11 A0" //"11 FF"版本号返回指令//仪器调教指令处理//仪器调试收到查询温度
                                    ...
                                    if (orderTemp == "F1 02")
                                    {
                                        ...
                                        if (tempII != "1F")
                                        {
                                            ...
                                            if (tempII[7] != '1')
                                            {
                                                //bit0:样品盘光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "加样模块样品盘光电开关未开！");
                                                //
                                            ...
                                            if (tempII[6] != '1')
                                            {
                                                //bit1:试剂盘光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "加样模块试剂盘光电开关未开！");
                                                //
                                            ...
                                            if (tempII[5] != '1')
                                            {
                                                //bit2:垂直臂光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "加样模块垂直臂光电开关未开！");
                                                //
                                            ...
                                            if (tempII[4] != '1')
                                            {
                                                //bit3:旋转臂光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "加样模块旋转臂光电开关未开！");
                                                //
                                            ...
                                            if (tempII[3] != '1')
                                            {
                                                //bit4:柱塞泵光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "加样模块柱塞泵光电开关未开！");
                                                //
                                        ...
                                        if (tempJJ != "3F")
                                        {
                                            ...
                                            if (tempJJ[7] != '1')
                                            {
                                                //bit0：温育盘光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "抓手模块温育盘光电开关未开！");
                                                //
                                            ...
                                            if (tempJJ[6] != '1')
                                            {
                                                //bit1：X轴光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "抓手模块X轴光电开关未开！");
                                                //
                                            ...
                                            if (tempJJ[5] != '1')
                                            {
                                                //bit2：Y轴光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "抓手模块Y轴光电开关未开！");
                                                //
                                            ...
                                            if (tempJJ[4] != '1')
                                            {
                                                //bit3：Z轴光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "抓手模块Z轴光电开关未开！");
                                                //
                                            ...
                                            if (tempJJ[3] != '1')
                                            {
                                                //bit4：压杯光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "抓手模块压杯光电开关未开！");
                                                //
                                            ...
                                            if (tempJJ[2] != '1')
                                            {
                                                //bit5：垂直光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "抓手模块垂直光电开关未开！");
                                                //
                                        ...
                                        if (tempKK != "F")
                                        {
                                            ...
                                            if (tempKK[7] != '1')
                                            {
                                                //bit0:清洗盘光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "清洗模块清洗盘光电开关未开！");
                                                //
                                            ...
                                            if (tempKK[6] != '1')
                                            {
                                                //bit1:压杯光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "清洗模块压杯光电开关未开！");
                                                //
                                            ...
                                            if (tempKK[5] != '1')
                                            {
                                                //bit2:垂直光电开关未开
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "清洗模块垂直光电开关未开！");
                                                //
                                            ...
                                            if (tempKK[4] != '1')
                                            {
                                                //bit3: 柱塞泵光电开关未开;
                                                //frmMS = new frmMessageShow();
                                                //MessageBox.Show("初始化检测", "清洗模块柱塞泵光电开关未开！");
                                                //
                                        ...
                                        //{
                                        //    //frmMS = new frmMessageShow();
                                        //    //MessageBox.Show("初始化检测结果", ErrorMessage);
                                        //    //
